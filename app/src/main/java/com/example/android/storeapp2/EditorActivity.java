...
public class EditorActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    private void saveProduct() {
        ...
        if (mCurrentProductUri == null &&
            ...
            values.put(StoreContract.ProductEntry.COLUMN_PROD_NAME, nameString);
            values.put(StoreContract.ProductEntry.COLUMN_PRICE, price);
            values.put(StoreContract.ProductEntry.COLUMN_QTY, qty);
            values.put(StoreContract.ProductEntry.COLUMN_SUPPLIER, supplierNameString);
            values.put(StoreContract.ProductEntry.COLUMN_PHONE, phone);
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor cursor) {
        ...
        if (cursor.moveToFirst()) {
            ...
            int suppphoneColumnIndex = cursor.getColumnIndex(StoreContract.ProductEntry.COLUMN_PHONE);
